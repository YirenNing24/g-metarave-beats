...
var bkmrValidateSession: Object = null
...
func _on_VersionCheck_request_completed(_result, response_code, headers, body) -> void:

	var _status_check = BKMRUtils.check_http_response(response_code, headers, body)
...
func register_player_anon(player_name: String = "") -> Node:
	...
	var request_url = host + "/api/register"
...
func _on_RegisterPlayer_request_completed(_result, response_code, headers, body) -> void:
...
func _on_RegisterPlayerUserPassword_request_completed(_result, response_code, headers, body) -> void:
...
func _on_VerifyEmail_request_completed(_result, response_code, headers, body) -> void:
	var status_check = BKMRUtils.check_http_response(response_code, headers, body)
...
func resend_conf_code(player_name: String) -> Node:
	...
	var request_url = host + "/resend_conf_code"
...
func _on_LoginPlayer_request_completed(_result, response_code, headers, body) -> void:
	var status_check: bool = BKMRUtils.check_http_response(response_code, headers, body)
...
func _on_ValidateSession_request_completed(_result, response_code, headers, body) -> void:
	var status_check: bool = BKMRUtils.check_http_response(response_code, headers, body)
	...
	if status_check:
		...
		if json_body.success:
			...
			set_player_logged_in(json_body.username)
