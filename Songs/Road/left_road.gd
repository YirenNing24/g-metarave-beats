...
func get_bar_data() -> Array[Dictionary]:
	var irene_data: Dictionary = tracks_data[5].bars[current_bar_index]
	var seulgi_data: Dictionary = tracks_data[6].bars[current_bar_index]
	var wendy_data: Dictionary = tracks_data[7].bars[current_bar_index]
	var joy_data: Dictionary = tracks_data[8].bars[current_bar_index]
	var yeri_data: Dictionary = tracks_data[9].bars[current_bar_index]
	return [irene_data, seulgi_data, wendy_data, joy_data, yeri_data] as Array[Dictionary]
