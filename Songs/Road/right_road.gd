...
func get_bar_data() -> Array:
	var irene_data: Dictionary = tracks_data[10].bars[current_bar_index]
	var seulgi_data: Dictionary = tracks_data[11].bars[current_bar_index]
	var wendy_data: Dictionary = tracks_data[12].bars[current_bar_index]
	var joy_data: Dictionary = tracks_data[13].bars[current_bar_index]
	var yeri_data: Dictionary = tracks_data[14].bars[current_bar_index]
